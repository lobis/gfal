...
GFAL_DEPLOYMENT_HTTP_WRITABLE_BASE=https://eos-mgm:8443${WRITABLE_PATH}
GFAL_DEPLOYMENT_HTTP_DENIED_BASE=https://eos-mgm:8443${DENIED_PATH}
GFAL_DEPLOYMENT_ROOT_WRITABLE_BASE=root://eos-mgm:1094/${WRITABLE_PATH}
GFAL_DEPLOYMENT_ROOT_DENIED_BASE=root://eos-mgm:1094/${DENIED_PATH}
EOF
