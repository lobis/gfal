...
# Note: full XRootD support requires separate xrootd Python bindings, which
...
Supports HTTP/HTTPS out of the box. Full XRootD support requires separate
xrootd Python bindings in the environment.
